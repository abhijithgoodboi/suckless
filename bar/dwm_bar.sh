...
do
    ...
    upperbar="$upperbar$(cpu_info)"
    upperbar="$upperbar$(mem_info)"
    upperbar="$upperbar$(get_wifi)"
    ...
    upperbar="$upperbar$(get_date)"
    #upperbar="$upperbar$(dwm_pulse)"
    # upperbar="$upperbar$(dwm_bluetooth)"
    #upperbar="$upperbar$(get_time)"
